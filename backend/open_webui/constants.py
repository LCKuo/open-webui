...
class ERROR_MESSAGES(str, Enum):
    ...
    WEB_SEARCH_ERROR = lambda err='': str(err) if err else 'Something went wrong while searching the web.'
    ...
    SERVER_CONNECTION_ERROR = 'Interact Ai: Server Connection Error'
